...
@api_view()
def home(request):
    return  render(request, 'calendar_api.html')
...
def GoogleCalendarRedirectView(request):
    try:
        ...
        for event in events:
            ...
            listEvents.append({"start" : start, "summary" : event['summary']})
        return render(request, 'event_schedule.html',{'listEvents': listEvents})
